...
for sym in actives:
    ...
    prompt = f"""
                ...
                analiza los siguientes datos antes de decidir no te apresures a vender si no tienes una señal clara de venta solo debes responder en el formato que explica en la base de conocimientos
                {sym}
                """
