...
for sym in actives:
    ...
    prompt = f"""
                ...
                analiza los siguientes datos antes de decidir, recuerda que el objetivo es maximizar ganancias y minimizar perdidas, solo debes responder en el formato que explica en la base de conocimientos
                {sym}
                """
